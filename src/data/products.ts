...
export const products: Product[] = [
  ...
  // 1. Hawan Samagri Balaji Box
  {
    ...
    weight: "500g",
    images: ["/images/products-studio/Hawan bala ji box.jpg"],
    inStock: true,
    rating: 4.7,
    reviewCount: 38,
  ...
  // 2. Hawan Samagri Balaji Packet
  {
    ...
    weight: "250g",
    images: ["/images/products-studio/Hawan bala ji packet.jpg"],
    inStock: true,
    rating: 4.5,
    reviewCount: 27,
  ...
  // 3. Hawan Samagri Mysore Wood
  {
    ...
    weight: "200g",
    images: ["/images/products-studio/Hawan maysoor wood.jpg"],
    inStock: true,
    rating: 4.8,
    reviewCount: 42,
  ...
  // 4. Vedang Hawan Samagri
  {
    ...
    weight: "500g",
    images: ["/images/products-studio/Vedang hawan .jpg"],
    inStock: true,
    rating: 4.9,
    reviewCount: 45,
  ...
  // 5. Samidhaa - Sacred Fire Wood
  {
    ...
    weight: "250g",
    images: ["/images/products-studio/Samidhaa .jpg"],
    inStock: true,
    rating: 4.4,
    reviewCount: 19,
  ...
  // 6. Balaji Premium Dhoop
  {
    ...
    weight: "100g",
    images: ["/images/products-studio/Bala ji.jpg"],
    inStock: true,
    rating: 4.3,
    reviewCount: 22,
  ...
  // 7. Guggal Box 12 Pieces
  {
    ...
    weight: "12 pcs",
    images: ["/images/products-studio/Gugal box 12pcs.jpg"],
    inStock: true,
    rating: 4.6,
    reviewCount: 34,
  ...
  // 8. Guggal A-Grade Pure
  {
    ...
    weight: "100g",
    images: ["/images/products-studio/Gugal a grade.jpg"],
    inStock: true,
    rating: 4.9,
    reviewCount: 48,
  ...
  // 9. Guggal Box Standard
  {
    ...
    discount: Math.round(((150 - 120) / 150) * 100),
    weight: "200g",
    images: ["/images/products-studio/Gugal box.jpg"],
    inStock: true,
    rating: 4.4,
    reviewCount: 29,
  ...
  // 10. Guggal Dhuni
  {
    ...
    weight: "150g",
    images: ["/images/products-studio/Gugal duni.jpg"],
    inStock: true,
    rating: 4.5,
    reviewCount: 18,
  ...
  // 11. Guggal Small Pack
  {
    ...
    weight: "50g",
    images: ["/images/products-studio/Gugal small.jpg"],
    inStock: true,
    rating: 4.2,
    reviewCount: 15,
  ...
  // 12. Kodia Loban Premium
  {
    ...
    weight: "200g",
    images: ["/images/products-studio/Kodia loban.jpg"],
    inStock: true,
    rating: 4.7,
    reviewCount: 36,
  ...
  // 13. Color Loban Assorted
  {
    ...
    weight: "200g",
    images: ["/images/products-studio/Loban color.jpg"],
    inStock: true,
    rating: 4.3,
    reviewCount: 21,
  ...
  // 14. Ganga Jal Big Bottle
  {
    ...
    discount: Math.round(((150 - 120) / 150) * 100),
    weight: "500ml",
    images: ["/images/products-studio/Ganga jal Big.jpg"],
    inStock: true,
    rating: 4.8,
    reviewCount: 50,
  ...
  // 15. Gulab Jal Pure Rose Water
  {
    ...
    discount: Math.round(((110 - 90) / 110) * 100),
    weight: "200ml",
    images: ["/images/products-studio/Gulab jal.jpg"],
    inStock: true,
    rating: 4.5,
    reviewCount: 32,
  ...
  // 16. Gulab Jal Premium Bottle
  {
    ...
    weight: "500ml",
    images: ["/images/products-studio/Gulab jal bottle.jpg"],
    inStock: true,
    rating: 4.6,
    reviewCount: 26,
  ...
  // 17. Gulab Jal 3-in-1 Pack
  {
    ...
    discount: Math.round(((300 - 250) / 300) * 100),
    weight: "3x200ml",
    images: ["/images/products-studio/Gulab jab 3in 1.jpg"],
    inStock: true,
    rating: 4.4,
    reviewCount: 17,
  ...
  // 18. Kewra Water
  {
    ...
    discount: Math.round(((100 - 80) / 100) * 100),
    weight: "200ml",
    images: ["/images/products-studio/Kewra water.jpg"],
    inStock: true,
    rating: 4.3,
    reviewCount: 14,
  ...
  // 19. Kewra Water Big Bottle
  {
    ...
    discount: Math.round(((170 - 140) / 170) * 100),
    weight: "500ml",
    images: ["/images/products-studio/Kewra water big.jpg"],
    inStock: true,
    rating: 4.4,
    reviewCount: 11,
  ...
  // 20. 27 Kua Jal Sacred Water
  {
    ...
    weight: "200ml",
    images: ["/images/products-studio/27kua jal.jpg"],
    inStock: true,
    rating: 4.7,
    reviewCount: 23,
  ...
  // 21. Chandan Dust 12 Pieces
  {
    ...
    discount: Math.round(((200 - 160) / 200) * 100),
    weight: "12 pcs",
    images: ["/images/products-studio/Chandan dust 12pcs.jpg"],
    inStock: true,
    rating: 4.5,
    reviewCount: 28,
  ...
  // 22. Chandan Tika Yellow
  {
    ...
    weight: "50g",
    images: ["/images/products-studio/Chandan tika pila.jpg"],
    inStock: true,
    rating: 4.3,
    reviewCount: 20,
  ...
  // 23. Pila Chandan Tilak
  {
    ...
    weight: "40g",
    images: ["/images/products-studio/Pila chandan tilak.jpg"],
    inStock: true,
    rating: 4.2,
    reviewCount: 16,
  ...
  // 24. White Chandan Tika
  {
    ...
    discount: Math.round(((100 - 80) / 100) * 100),
    weight: "50g",
    images: ["/images/products-studio/White chandan tika.jpg"],
    inStock: true,
    rating: 4.6,
    reviewCount: 25,
  ...
  // 25. Lal Chandan Tika Red
  {
    ...
    weight: "50g",
    images: ["/images/products-studio/Lal chandan tika.jpg"],
    inStock: true,
    rating: 4.5,
    reviewCount: 30,
  ...
  // 26. Mysore Chandan 12 Dozen Mini
  {
    ...
    weight: "12 dozen",
    images: ["/images/products-studio/Chnadan mysore 12 doz min.jpg"],
    inStock: true,
    rating: 4.8,
    reviewCount: 40,
  ...
  // 27. Chandan Powder Malyagiri Bag
  {
    ...
    discount: Math.round(((250 - 200) / 250) * 100),
    weight: "100g",
    images: ["/images/products-studio/Chnadan powder malyagiri bag.jpg"],
    inStock: true,
    rating: 4.7,
    reviewCount: 33,
  ...
  // 28. Malyagiri Sandalwood Powder
  {
    ...
    discount: Math.round(((220 - 180) / 220) * 100),
    weight: "50g",
    images: ["/images/products-studio/MAlyagiri sandal powder.jpg"],
    inStock: true,
    rating: 4.6,
    reviewCount: 24,
  ...
  // 29. Malyagiri Chandan Powder Premium
  {
    ...
    weight: "100g",
    images: ["/images/products-studio/Malyagiri chandan powder.jpg"],
    inStock: true,
    rating: 4.9,
    reviewCount: 37,
  ...
  // 30. Malyagiri Powder Pack
  {
    ...
    weight: "50g",
    images: ["/images/products-studio/Malyagiri powder pack.jpg"],
    inStock: true,
    rating: 4.4,
    reviewCount: 19,
  ...
  // 31. Kumkum Packet Pure
  {
    ...
    weight: "50g",
    images: ["/images/products-studio/kum kum packet.jpg"],
    inStock: true,
    rating: 4.3,
    reviewCount: 35,
  ...
  // 32. Red Powder Sindoor
  {
    ...
    weight: "50g",
    images: ["/images/products-studio/Red Powder.jpg"],
    inStock: true,
    rating: 4.2,
    reviewCount: 18,
  ...
  // 33. Kalash Powder
  {
    ...
    discount: Math.round(((75 - 60) / 75) * 100),
    weight: "100g",
    images: ["/images/products-studio/Kalash Powder.jpg"],
    inStock: true,
    rating: 4.1,
    reviewCount: 12,
  ...
  // 34. Bhojpatra Sacred Bark
  {
    ...
    discount: Math.round(((180 - 150) / 180) * 100),
    weight: "assorted",
    images: ["/images/products-studio/Bhojpatra all.jpg"],
    inStock: true,
    rating: 4.6,
    reviewCount: 22,
  ...
  // 35. Janeu Sacred Thread Big
  {
    ...
    discount: Math.round(((65 - 50) / 65) * 100),
    weight: "1 pc",
    images: ["/images/products-studio/Janeu Big.jpg"],
    inStock: true,
    rating: 4.4,
    reviewCount: 15,
  ...
  // 36. Janeu Sacred Thread Small
  {
    ...
    weight: "1 pc",
    images: ["/images/products-studio/Janeu small.jpg"],
    inStock: true,
    rating: 4.3,
    reviewCount: 10,
  ...
  // 37. Kush Dandi Sacred Grass
  {
    ...
    discount: Math.round(((100 - 80) / 100) * 100),
    weight: "bundle",
    images: ["/images/products-studio/Kush dandi.jpg"],
    inStock: true,
    rating: 4.5,
    reviewCount: 20,
  ...
  // 38. Gaumutra Pure Cow Urine
  {
    ...
    discount: Math.round(((90 - 70) / 90) * 100),
    weight: "200ml",
    images: ["/images/products-studio/Gaumutra .jpg"],
    inStock: true,
    rating: 4.4,
    reviewCount: 16,
  ...
  // 39. Pure Honey for Pooja
  {
    ...
    discount: Math.round(((180 - 150) / 180) * 100),
    weight: "250g",
    images: ["/images/products-studio/Honey .jpg"],
    inStock: true,
    rating: 4.6,
    reviewCount: 27,
  ...
  // 40. Ashtagandha Paste
  {
    ...
    discount: Math.round(((150 - 120) / 150) * 100),
    weight: "50g",
    images: ["/images/products-studio/Asthgandh.jpg"],
    inStock: true,
    rating: 4.7,
    reviewCount: 31,
  ...
  // 41. Kashi Bhasma Sacred Ash
  {
    ...
    discount: Math.round(((110 - 90) / 110) * 100),
    weight: "100g",
    images: ["/images/products-studio/Kashi bashm .jpg"],
    inStock: true,
    rating: 4.5,
    reviewCount: 23,
  ...
  // 42. Mutha Bada Nagarmotha
  {
    ...
    weight: "100g",
    images: ["/images/products-studio/Mutha bada.jpg"],
    inStock: true,
    rating: 4.3,
    reviewCount: 13,
  ...
  // 43. Agar Tagar
  {
    ...
    discount: Math.round(((160 - 130) / 160) * 100),
    weight: "100g",
    images: ["/images/products-studio/Agar_Tagar.jpg"],
    inStock: true,
    rating: 4.6,
    reviewCount: 25,
  ...
  // 44. Agar Wood Premium Box
  {
    ...
    weight: "50g",
    images: ["/images/products-studio/Agar Wood Box.jpg"],
    inStock: true,
    rating: 4.9,
    reviewCount: 44,
  ...
  // 45. Tagar Lakdi Box
  {
    ...
    discount: Math.round(((140 - 110) / 140) * 100),
    weight: "100g",
    images: ["/images/products-studio/Tagar lakdi box.jpg"],
    inStock: true,
    rating: 4.4,
    reviewCount: 17,
  ...
  // 46. 5 Ratan Pooja Set
  {
    ...
    discount: Math.round(((250 - 200) / 250) * 100),
    weight: "1 set",
    images: ["/images/products-studio/5 ratan.jpg"],
    inStock: true,
    rating: 4.7,
    reviewCount: 35,
  ...
  // 47. 56 Bhog Offering Set
  {
    ...
    discount: Math.round(((420 - 350) / 420) * 100),
    weight: "1 set",
    images: ["/images/products-studio/56 bhog (1).jpg"],
    inStock: true,
    rating: 4.8,
    reviewCount: 41,
  ...
  // 48. Ubtan Natural Face Pack
  {
    ...
    discount: Math.round(((150 - 120) / 150) * 100),
    weight: "100g",
    images: ["/images/products-studio/Ubtan .jpg"],
    inStock: true,
    rating: 4.5,
    reviewCount: 29,
  ...
  // 49. Ubtan Gift Box
  {
    ...
    discount: Math.round(((220 - 180) / 220) * 100),
    weight: "200g",
    images: ["/images/products-studio/Ubtan Box.jpg"],
    inStock: true,
    rating: 4.6,
    reviewCount: 24,
  ...
  // 50. Attar 12 Pcs Box Collection
  {
    ...
    weight: "12 pcs",
    images: ["/images/products-studio/Attar 12 pcs box .jpg"],
    inStock: true,
    rating: 4.8,
    reviewCount: 46,
  ...
  // 51. Attar 24 Pcs Box Collection
  {
    ...
    weight: "24 pcs",
    images: ["/images/products-studio/Attar box 24pcs.jpg"],
    inStock: true,
    rating: 4.9,
    reviewCount: 39,
  ...
  // 52. Attar 8 Pcs Box
  {
    ...
    discount: Math.round(((420 - 350) / 420) * 100),
    weight: "8 pcs",
    images: ["/images/products-studio/Attar box 8pcs.jpg"],
    inStock: true,
    rating: 4.6,
    reviewCount: 28,
  ...
  // 53. Attar Alshan Premium
  {
    ...
    discount: Math.round(((220 - 180) / 220) * 100),
    weight: "10ml",
    images: ["/images/products-studio/Attar Alshan.jpg"],
    inStock: true,
    rating: 4.7,
    reviewCount: 33,
  ...
  // 54. Attar Kesar Chandan
  {
    ...
    discount: Math.round(((250 - 200) / 250) * 100),
    weight: "10ml",
    images: ["/images/products-studio/Attar keshar chandan.jpg"],
    inStock: true,
    rating: 4.8,
    reviewCount: 43,
  ...
  // 55. Attar Kewra Gulab Mix
  {
    ...
    weight: "10ml",
    images: ["/images/products-studio/Attar kewra gulab mix.jpg"],
    inStock: true,
    rating: 4.5,
    reviewCount: 22,
  ...
  // 56. Attar Mix Bag Bottle
  {
    ...
    discount: Math.round(((190 - 150) / 190) * 100),
    weight: "10ml",
    images: ["/images/products-studio/Attar mix Bag bottle.jpg"],
    inStock: true,
    rating: 4.3,
    reviewCount: 16,
  ...
  // 57. Attar Mix Box Bottle Big
  {
    ...
    discount: Math.round(((300 - 250) / 300) * 100),
    weight: "25ml",
    images: ["/images/products-studio/Attar mix Box Bottle big.jpg"],
    inStock: true,
    rating: 4.5,
    reviewCount: 20,
  ...
  // 58. Chameli Mini Bottle
  {
    ...
    discount: Math.round(((150 - 120) / 150) * 100),
    weight: "10ml",
    images: ["/images/products-studio/Chameli min bottle.jpg"],
    inStock: true,
    rating: 4.6,
    reviewCount: 26,
  ...
  // 59. Chameli Oil Mix
  {
    ...
    discount: Math.round(((200 - 160) / 200) * 100),
    weight: "25ml",
    images: ["/images/products-studio/Chameli oli mix.jpg"],
    inStock: true,
    rating: 4.4,
    reviewCount: 19,
  ...
  // 60. Magic Scent Box Collection
  {
    ...
    weight: "6 pcs",
    images: ["/images/products-studio/Magic sent box.jpg"],
    inStock: true,
    rating: 4.7,
    reviewCount: 30,
  ...
  // 61. Scent Mix Assorted
  {
    ...
    discount: Math.round(((270 - 220) / 270) * 100),
    weight: "6 pcs",
    images: ["/images/products-studio/Scent mix.jpg"],
    inStock: true,
    rating: 4.3,
    reviewCount: 18,
  ...
  // 62. Mix 12 Dozen Injection Bottle Box
  {
    ...
    weight: "12 dozen",
    images: ["/images/products-studio/Mix 12 doz injection box.jpg"],
    inStock: true,
    rating: 4.5,
    reviewCount: 14,
  ...
  // 63. Singh Brand Injection Attar
  {
    ...
    discount: Math.round(((220 - 180) / 220) * 100),
    weight: "10ml",
    images: ["/images/products-studio/Singh brand Injection.jpg"],
    inStock: true,
    rating: 4.4,
    reviewCount: 21,
